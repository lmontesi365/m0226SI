...
* ### 🛡️ 1. [Seguretat Activa](activa_pasiva.md)
...
### 🩹 2. [Seguretat Passiva](activa_pasiva.md)
* Conjunt de mesures i mecanismes que s'activen un cop s'ha produït un incident o atac per minimitzar els danys i recuperar la normalitat.
* **Guia d'estudi:** Revisa les estratègies de còpies de seguretat (Backups), sistemes d'alimentació ininterrompuda (SAI/UPS), sistemes d'extinció d'incendis i el Pla de Recuperació de Desastres (DRP).

### 💻 3. [Seguretat Lògica](seguretat-fisica-logica/seguretat-logica.md)
* Conjunt de mesures aplicades mitjançant programari i configuracions per protegir la informació, els processos i les aplicacions.
* **Guia d'estudi:** Revisa els mètodes d'autenticació i autorització (mecanismes RBAC/ACL), permisos de fitxers, protocols de xarxa segurs (TLS/SSH) i el control de malware.

### 🏢 3. [Seguretat Física](seguretat-fisica-logica/seguretat-fisica.md)
...
### 💻 4. [Seguretat Lògica](seguretat-fisica-logica/seguretat-logica.md)
...
### 🏙️ 5. [Centre de Processament de Dades (CPD)](servidors.md)
...
### 🔋 6. [Sistemes d'Alimentació Ininterrompuda (SAI / UPS)](SAI.md)
...
### 🐧 7. [Llistes de Control d'Accés (ACL) a Linux](../ra3/acl.md)
...
### 🪟 8. [Llistes de Control d'Accés (ACL) a Windows](../ra3/acl_windows.md)
...
| **Seguretat Activa i Passiva** | Teòric | Conjunt de mesures preventives / o de recuperació  | [Anar ➡️](activa_pasiva.md) |
