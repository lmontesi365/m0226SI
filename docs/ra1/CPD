...
- **SLA (Service Level Agreement)** amb % de disponibilitat garantit (99.9% mínimo)
...
**Infraestructura:**
- 🚗 Carreteres principals propers (no callejons)
...
- 🚫 NO pròxim a recepcions (menys vigilans)
...
**Solucions:**
- 📦 **Ascensor gran** (mínimo 2000 kg de capacitat)
- 🚪 **Puertes d'ascensor suficientment grans** (> 1.2m d'ample)
...
- Fallos cascada en servidors

**Evitar proximitat a:**
- 🚰 Lavabos i banys
- 🍳 Cuines i sales de menjar
- 🔌 Canonades verticals (ascensorós per planta)
- 🪟 Finestres en dias plujosos
...
**Problema:** Els servidors en racks pesin molt i estan concentrats en poc espai
...
- ✅ Espai per a colocació de cablejat
...
| **Monitoritzaciò** | Sensors continus amb alarma |
...
- 🚨 Detectores de sants (automàtiques)
- 🧯 Sistemes d'extinció amb gas inert (no afecta els equips)
- 💨 Detecció de sants inciodent (pre-incendi)
...
- 📹 Cámara de seguridad apuntando a la puerta
- 📊 Registro de todos los accesos (quién, cuándo)
- 🔔 Alarma si alguien entra sin autorización

### 3.4 SAI/UPS (Alimentació Ininterrompuda)

- ⏱️ Autonomia mínima: 10-15 minuts (permetre aturada controlada)
- 🔌 Connectat a tots els sistemes crítics
- 📈 Capacidad proporcional a la demanda
- 🔄 Prova mensual de transferencia automàtica

---

## 📋 Xlist de Verificació per a CPD
...
- [ ] Temperature 18-27ºC, humitat 40-55%
- [ ] Detectors de sants i extinció automàtica
...
L'ubicació i el disseny d'un CPD és **crítica per a la disponibilitat i seguretat** de les operacions informàtiques. Una bona ubicació prevé la majoria de fallos físics i permet que la seguretat lògica funcioni correctament.
